...
<template>
  <div class="page">
      ...
      <div class="brand-section">
        <div class="brand-row">
          ...
          <div class="brand-text">
            <span class="brand-name">GavinYinHub</span>
            ...
            <div class="petal-float-wrap">
              <transition name="petals-fade">
                ...
                >
                  <span
                    class="petal-char"
                    style="--px: 15%; --pd: 0s; --pdx: -4px"
                    >✿</span
                  >
                  <span
                    class="petal-char"
                    style="--px: 48%; --pd: 0.35s; --pdx: 3px"
                    >✿</span
                  >
                  <span
                    class="petal-char"
                    style="--px: 78%; --pd: 0.18s; --pdx: -2px"
                    >✿</span
                  >
                </div>
              </transition>
    ...
    <p class="copyright">© 2025 GavinYinHub · All Rights Reserved</p>
  </div>
</template>
